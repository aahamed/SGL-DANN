...
parser.add_argument('--src_set', type=str, default='mnist',
                    help='name of the src domain dataset')
parser.add_argument('--tgt_set', type=str, default='mnistm',
                    help='name of the tgt domain dataset')
